  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-5">
      <div className="grid gap-3 md:grid-cols-4">
        <Field label="City, Hotel or Area" defaultValue="Goa, India" />
        <Field label="Check-In" type="date" defaultValue={today} />
        <Field label="Check-Out" type="date" />
        <Field label="Rooms & Guests" defaultValue="1 Room, 2 Adults" />
      </div>
