...
import { FaLock, FaMapMarkerAlt, FaStar, FaCheckCircle } from "react-icons/fa";
  ...
  if (confirmed) {
    return (
      <div className="bg-gray-50 min-h-screen py-10">
        <div className="max-w-2xl mx-auto px-4 bg-white rounded-lg shadow-sm border border-gray-100 p-8 text-center">
        ...
        <aside className="space-y-4">
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-4">
              ...
              <span className="inline-flex items-center gap-1 mt-2 bg-green-600 text-white text-xs font-bold px-2 py-0.5 rounded">
