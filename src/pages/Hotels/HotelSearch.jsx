...
import {useHotelSearch} from "./hooks/HotelSearchHook.ts";
...
export default function HotelSearch() {
  ...
  const [sort, setSort] = useState("popular");
    const {data, loading, error} = useHotelSearch({
        city,
        startDate: checkIn,
        endDate: checkOut,
        roomsCount: Number(guests?.split("Room")?.at(0) || '1')
    });
